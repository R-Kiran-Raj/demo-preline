...
const NavBar = () => {
  return (
    <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all p-4 bg-white mb-4">
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex items-center">
          ...
          <Popover>
            <PopoverTrigger className="middle none font-sans font-bold center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30 hidden items-center gap-1 px-4 xl:flex">
              <svg
            ...
            <PopoverContent className="bg-white border-1 border-slate-300 p-4 justify-center font-poppins rounded-lg shadow-md z-50">
